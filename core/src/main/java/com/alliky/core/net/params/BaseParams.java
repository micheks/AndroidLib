package com.alliky.core.net.params;

import android.text.TextUtils;

import com.alliky.core.net.body.FileBody;
import com.alliky.core.net.body.InputStreamBody;
import com.alliky.core.net.body.MultipartBody;
import com.alliky.core.net.body.RequestBody;
import com.alliky.core.net.body.StringBody;
import com.alliky.core.net.body.UrlEncodedBody;
...
public abstract class BaseParams {
     ...
     *                        kv结构自定义设置会被忽略, 默认使用:"application/Utils-www-form-urlencoded;charset=" + charset;
