package com.alliky.core.net.common.task;
            ...
            try {
                switch (msg.what) {
                    ...
                    case MSG_WHAT_ON_ERROR: {
                        ...
                        Logger.d(throwable.getMessage(), throwable);
                    ...
                    case MSG_WHAT_ON_CANCEL: {
                        ...
                        assert args != null;
                        taskProxy.task.onCancelled((com.alliky.core.net.common.Callback.CancelledException) args[0]);
                        break;
                    }
