...
import com.alliky.core.dialog.util.SafelyHandlerWrapper;
import com.alliky.core.dialog.util.TextInfo;
import com.alliky.core.dialog.util.view.NotifyToastShadowView;
...
public class Notification {
    ...
    private void showKongzueNotification() {
        LayoutInflater inflater = (LayoutInflater) context.get().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        rootView = (NotifyToastShadowView) inflater.inflate(R.layout.notification, null);
