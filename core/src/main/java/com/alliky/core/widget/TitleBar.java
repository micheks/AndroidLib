...
import com.alliky.core.util.ScreenUtil;
import com.alliky.core.util.StatusBarUtils;
...
public class TitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void initGlobalViews(Context context) {
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1, ScreenUtil.dp2PxInt(context, 0.4f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT, Math.max(1, ScreenUtil.dp2PxInt(context, 0.4f)));
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            // 设置边距
            centerParams.topMargin = ScreenUtil.dp2PxInt(context, 7);
            centerParams.bottomMargin = ScreenUtil.dp2PxInt(context, 7);
            ...
            int searchIconWidth = ScreenUtil.dp2PxInt(context, 15);
            ...
            etSearchHint.setTextSize(TypedValue.COMPLEX_UNIT_PX, ScreenUtil.dp2PxInt(context, 14));
...
//            }
    ...
    public void showSoftInputKeyboard(boolean show) {
        if (centerSearchEditable && show) {
            ...
            ScreenUtil.showSoftInputKeyBoard(getContext(), etSearchHint);
        } else {
            ScreenUtil.hideSoftInputKeyBoard(getContext(), etSearchHint);
        }
    }
